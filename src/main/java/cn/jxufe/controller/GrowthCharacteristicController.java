...
public class GrowthCharacteristicController {
    ...
    @GetMapping
    @Operation(summary = "获取所有生长特性", description = "获取系统中所有生长特性的列表")
    public ResponseEntity<List<GrowthCharacteristicDTO>> getAllGrowthCharacteristics() {
        return ResponseEntity.ok(growthCharacteristicService.getAllGrowthCharacteristics());
    }
